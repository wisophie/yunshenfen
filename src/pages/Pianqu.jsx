...
export default function Pianqu() {
  ...
  return (
    <PianquStyled><div><h1>片区复盘</h1></div>
      <div className='wrap'>
        {/* <label for="story">大佳何复盘:</label> */}
        <textarea defaultValue={`大佳何复盘：存在问题：1、${p1}2、${p2}
提升举措：1、${w1}2、${w2}${f}`}
